...
export const team: Member[] = [
  ...
  },
  {
    ...
    department: 'Creative',
    tier: 'lead',
    bio: "Pritam leads creative direction at DEV Community Nepal, crafting visual identities, branding, and engaging digital experiences.",
    skills: [],
    image: '/images/team/pritam.jpeg',
    socials: [{ label: 'LinkedIn', href: 'https://www.linkedin.com/company/devcommunitynepal/' }],
  },
];
